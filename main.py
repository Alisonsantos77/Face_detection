...
reconhecedor_rosto = reconhecimento_rosto.FaceDetection()  # criando o item que consegue ler uma imagem e reconhecer
# os rostos ali dentro
...
while webcam.isOpened():
    ...
    cv2.imshow("Detector de rostos", imagem)  # mostra a imagem da webcam para a gente
    if cv2.waitKey(5) == 27:  # ESC # garante que o código vai ser pausado ao apertar ESC (código 27)
        # o código vai esperar 5 milisegundos a cada leitura da webcam
        break
